...
lib = np.ctypeslib.load_library("arisparse", os.path.dirname("."))#__file__))
...
def load_beam_widths(fp="beam_widths/BeamWidths_ARIS1800_96.h"):
    beam_widths = []
    with open(fp) as f:
        for line in f:
...
def load_frames(aris_fp, beam_width_fp="beam_widths/BeamWidths_ARIS1800_96.h"):
    ...
    inputPath = ctypes.c_char_p(aris_fp)
